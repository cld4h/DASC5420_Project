...
\title{Machine learning approach for wildfire burned area prediction\\
}
...
\begin{abstract}
We are trying to construct a machine learning model to predict the burned area of forest fires based on meteorological conditions reported by local sensors (e.g. temperature, wind).
\end{abstract}

\begin{IEEEkeywords}
Regression, Wildfire, Landscape simulation, Burn probability, fire weather, fire grouth rate
\end{IEEEkeywords}
